...
import { BRAND_SETTING_KEYS, isBrandSettingKey } from '@/lib/branding/brandTokens'
...
export function isManagedSettingKey(key: string) {
  return (MANAGED_SETTING_KEYS as readonly string[]).includes(key) || isBrandSettingKey(key)
}
