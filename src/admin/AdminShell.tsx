...
const NAV_ITEMS: { label: string; to: string; icon: LucideIcon; exact?: boolean }[] = [
  ...
  { label: 'Listings', to: '/admin/catalog', icon: Package },
  { label: 'Real Estate', to: '/admin/real-estate', icon: Building2 },
  { label: 'Homepage', to: '/admin/homepage', icon: LayoutTemplate },
  { label: 'Site Content', to: '/admin/content', icon: FileText },
  { label: 'Payments & Clients', to: '/admin/commerce', icon: ShoppingBag },
