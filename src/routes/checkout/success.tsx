...
export const Route = createFileRoute('/checkout/success')({
  ...
  head: () => ({ meta: [{ title: 'Order Confirmed | GW Vacation Homes' }] }),
})
        ...
        {state === 'loading' ? (
          ...
          <>
            ...
            <p className="mt-3 max-w-md text-muted">
              Your enquiry has been sent to our team. We will review your request and get back to you shortly to discuss pricing and availability.
            </p>
