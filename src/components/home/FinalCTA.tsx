...
const FINAL_CTA_FALLBACK_IMAGE =
...
export function FinalCTA() {
  ...
  const backgroundImage = section.imageUrl?.trim() || FINAL_CTA_FALLBACK_IMAGE

  return (
    <section ref={ref} className="mx-6 my-20 overflow-hidden rounded-[14px] md:mx-14">
      <div className="relative h-[300px]">
        <img src={backgroundImage} alt="" className="final-cta-bg absolute inset-0 h-full w-full object-cover" />
