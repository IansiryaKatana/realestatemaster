...
export function RecommendedCollections() {
  ...
  const section = getSectionByKey(snapshot, 'recommended_collections')
    ...
    <section ref={ref} className="py-10">
      ...
      <div className="mb-8 text-center">
        <h2 className="font-display text-4xl font-extrabold text-text-brown">
          {section?.title ?? 'Explore Dubai Living'}
        </h2>
        <p className="mt-2 text-[11px] text-muted">
          {section?.subtitle ?? 'Curated areas and listing types to help you find your next home or investment.'}
        </p>
      </div>
