...
export function ProductHeroCarousel({ name, images, className, singleSlide = false, hideIndicators = false }: ProductHeroCarouselProps) {
  const [index, setIndex] = useState(0)
  const [visibleCount, setVisibleCount] = useState(singleSlide ? 1 : 3)
